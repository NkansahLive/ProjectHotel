...
SELECT * 
FROM projecthotel.hotel2018 
union 
SELECT * 
FROM projecthotel.hotel2019 
union 
SELECT *
FROM projecthotel.hotel2020
...
With hotels as ( SELECT * FROM projecthotel.hotel2018 union SELECT * FROM projecthotel.hotel2019 union SELECT * FROM projecthotel.hotel2020) 
SELECT * 
FROM hotels
...
FROM hotels order by arrival_date_year, 'Revenue'
...
SELECT * 
FROM hotels as h 
LEFT JOIN projecthotel.hotelmarketsegment as hms ON h.market_segment = hms.market_segment 
LEFT JOIN projecthotel.hotelmealcost as hmc ON h.meal = hmc.meal 
